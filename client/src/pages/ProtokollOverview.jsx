  ...
  return (
    <div className="p-3 md:p-4 max-w-[1400px] mx-auto h-full flex flex-col">
      ...
      <div className="flex items-center justify-between gap-2 mb-3">
        <h1 className="text-xl md:text-2xl font-bold">Protokoll-Übersicht</h1>
          ...
          <table className="min-w-[1100px] w-full text-sm">
            ...
            <tbody className="[&>tr>td]:px-2 [&>tr>td]:py-2">
              {rows.map((r) => {
                ...
                const kanal =
                  u.kanal ?? u.kanalNr ?? u.art ?? ""; // flexibel: verschiedene Feldnamen abdecken
                const richtungen = []
                ...
                return (
                  <tr
                    ...
                    onClick={() => {
                      window.location.hash = `/protokoll/edit/${r.nr}`;
                    }}
                    title="Zum Bearbeiten öffnen"
                  >
                    {/* Gelber Punkt bei erfolgreich gedruckt */}
                    ...
                    {/* Information auf 30 Zeichen begrenzt */}
                    <td className="whitespace-pre-wrap">
                      {short30(r.information)}
                    </td>

              {/* Information/Auftrag: zeigt den ausgewählten Typ */}
<td className="whitespace-pre-wrap">
  {r.infoTyp || "—"}
</td>
                  </tr>
